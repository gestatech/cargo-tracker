package be.gestatech.cargo.tracker.backend.application.facade.setup;
...
import be.gestatech.cargo.tracker.backend.domain.model.vo.location.SampleLocations;
import be.gestatech.cargo.tracker.backend.domain.model.vo.voyage.SampleVoyages;
import be.gestatech.cargo.tracker.backend.infrastructure.util.DateUtil;
...
public class SampleDataGenerator {
    ...
    private void loadSampleCargos() {
        ...
        RouteSpecification routeSpecification1 = new RouteSpecification(SampleLocations.HONGKONG, SampleLocations.HELSINKI, DateUtil.toDate("2016-03-15"));
        ...
        RouteSpecification routeSpecification2 = new RouteSpecification(SampleLocations.HANGZOU, SampleLocations.STOCKHOLM, DateUtil.toDate("2016-03-18"));
        ...
        RouteSpecification routeSpecification3 = new RouteSpecification(SampleLocations.HONGKONG, SampleLocations.MELBOURNE, DateUtil.toDate("2016-11-18"));
        ...
        RouteSpecification routeSpecification4 = new RouteSpecification(SampleLocations.NEWYORK, SampleLocations.DALLAS, DateUtil.toDate("2016-3-27"));

        Cargo mno456 = new Cargo(trackingId4, routeSpecification4);

        Itinerary itinerary4 = new Itinerary(Arrays.asList(new Leg(SampleVoyages.NEW_YORK_TO_DALLAS, SampleLocations.NEWYORK, SampleLocations.DALLAS, DateUtil.toDate("2016-10-24"), DateUtil.toDate("2016-10-25"))));
