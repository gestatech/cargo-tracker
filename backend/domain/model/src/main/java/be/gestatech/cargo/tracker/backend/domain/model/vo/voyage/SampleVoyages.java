...
import static be.gestatech.cargo.tracker.backend.domain.model.vo.location.SampleLocations.*;
import static be.gestatech.cargo.tracker.backend.infrastructure.util.DateUtil.toDate;
...
public class SampleVoyages {
    ...
    public static final Voyage HONGKONG_TO_NEW_YORK = new Voyage.Builder(new VoyageNumber("0100S"), HONGKONG)
            .addMovement(HANGZOU, toDate("2013-10-01", "12:00"), toDate("2013-10-03", "14:30"))
            .addMovement(TOKYO, toDate("2013-10-03", "21:00"), toDate("2013-10-06", "06:15"))
            .addMovement(MELBOURNE, toDate("2013-10-06", "11:00"), toDate("2013-10-12", "11:30"))
            .addMovement(NEWYORK, toDate("2013-10-14", "12:00"), toDate("2013-10-23", "23:10")).build();
    /**
    ...
    public static final Voyage NEW_YORK_TO_DALLAS = new Voyage.Builder(new VoyageNumber("0200T"), NEWYORK)
            .addMovement(CHICAGO, toDate("2013-10-24", "07:00"), toDate("2013-10-24", "17:45"))
            .addMovement(DALLAS, toDate("2013-10-24", "21:25"), toDate("2013-10-25", "19:30")).build();
    /**
    ...
    public static final Voyage DALLAS_TO_HELSINKI = new Voyage.Builder(new VoyageNumber("0300A"), DALLAS)
            .addMovement(HAMBURG, toDate("2013-10-29", "03:30"), toDate("2013-10-31", "14:00"))
            .addMovement(STOCKHOLM, toDate("2013-11-01", "15:20"), toDate("2013-11-01", "18:40"))
            .addMovement(HELSINKI, toDate("2013-11-02", "09:00"), toDate("2013-11-02", "11:15")).build();
    /**
     * Voyage number 0301S (by ship)
     * <p>
     * Dallas - Hamburg - Stockholm - Helsinki, alternate route
     */
    public static final Voyage DALLAS_TO_HELSINKI_ALT = new Voyage.Builder(new VoyageNumber("0301S"), DALLAS)
            .addMovement(HELSINKI, toDate("2013-10-29", "03:30"), toDate("2013-11-05", "15:45"))
            .build();
    /**
    ...
    public static final Voyage HELSINKI_TO_HONGKONG = new Voyage.Builder(new VoyageNumber("0400S"), HELSINKI)
            .addMovement(ROTTERDAM, toDate("2013-11-04", "05:50"), toDate("2013-11-06", "14:10"))
            .addMovement(SHANGHAI, toDate("2013-11-10", "21:45"), toDate("2013-11-22", "16:40"))
            .addMovement(HONGKONG, toDate("2013-11-24", "07:00"), toDate("2013-11-28", "13:37")).build();
